let sizeOfLab = 20;                 // zmien wielkosc planszy od 3x3 do 25x25
let example = 2;                    // zmien wersje od 0 do 2
let speedInLab = 5;                // zmien szybkosc: 60 da 1 klatke na sec, 20 da 3 klatki na sec
...
console.log(baseOfRoad1);
console.log(baseOfRoad2);
let onExit1 = false;
let onExit2 = false;
let r = 50;
let g = 50;
    ...
    sketch.setup = function(){
        ...
        for(let i=0; i< labAct.length; i++){
            ...
            if(labAct[i].posX == 0 && labAct[i].posY == 0){
                sketch.push();
                sketch.fill(255,255,15);
                sketch.noStroke();
                sketch.rect(10 + positionX, 10 + positionY, 50 , 50);
                sketch.pop();
            }
    ...
    sketch.draw = function(){
        if (sketch.frameCount%speedInLab==0){
            if(!onExit1){
                ...
                sketch.fill(r,g,b);
                sketch.noStroke();
                sketch.rect(20 + positionXDFS*50, 20 + positionYDFS*50, 30 , 30);
                sketch.pop();
                if (!v.visited1){
...
var l2 = function(sketch){
    sketch.setup = function(){
        ...
        canvas2.position(100 + sizeOfLab*50,80);
